$DIC_PATH = "C:/mecab/share/mecab-ko-dic"
$USERDIC_PATH = "C:/mecab/share/mecab-ko-dic\user-dic"
$MECAB_EXEC_PATH = "C:/mecab/bin\mecab.exe"
$DICT_INDEX = "C:/mecab/bin\mecab-dict-index.exe"
